exports.init = function () {
    return [
        ...
        "CREATE TABLE iobroker.ts_number (id INTEGER, ts INTEGER, val REAL, ack boolean, _from INTEGER, q INTEGER, PRIMARY KEY(id, ts));",
        "CREATE TABLE iobroker.ts_string (id INTEGER, ts INTEGER, val TEXT,    ack boolean, _from INTEGER, q INTEGER, PRIMARY KEY(id, ts));",
...
exports.getIdInsert = function (name, type) {
    return  "INSERT INTO iobroker.datapoints VALUES('" + name + "', " + type + ");";
};
...
exports.getFromInsert = function (from) {
    return "INSERT INTO iobroker.sources VALUES('" + from + "');";
};
